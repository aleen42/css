...
- It's currently only supported by Firefox browser, and see the examples with Firefox to clarify the differences between `[dir=""]` and `:dir()`. `[dir=""]` is supported by Chrome at this time
